...
namespace Varia
{
    class BiomeGen : ModWorld
    {
        public override void ModifyWorldGenTasks(List<GenPass> tasks, ref float totalWeight)
        {
            ...
            tasks.Add(new PassLegacy("Making the world rotten", delegate (GenerationProgress progress)
            {
                for (int i = 0; i < Main.maxTilesX / 250; ++i) //Repeats ~16 times on a small world (i.e. 16 biomes/world)
                {
                    ...
                    if (!AreaContains(pos, 30, TileID.BlueDungeonBrick) && !AreaContains(pos, 30, TileID.GreenDungeonBrick) && !AreaContains(pos, 30, TileID.PinkDungeonBrick) && !AreaContains(pos, 30, TileID.LihzahrdBrick) && !AreaContains(pos, 30, TileID.StoneSlab)) //checks for unwanted blocks
            ...
            /*ErrorLogger.ClearLogs();
            tasks.Add(new PassLegacy("Growing Extractinum", delegate (GenerationProgress progress)
            {
        ...
        public void GenBreeze()
        {
            int x = 160;
            int y = 40;
            MiniIsland(new Point(x + Main.rand.Next(0, 11), y + Main.rand.Next(88, 102)), 1);
            MiniIsland(new Point(x + Main.rand.Next(0, 11), y + Main.rand.Next(44, 66)), 2);
            MiniIsland(new Point(x + Main.rand.Next(75, 86), y + Main.rand.Next(44, 66)), 2);
            MiniIsland(new Point(x + Main.rand.Next(75, 86), y + Main.rand.Next(88, 102)), 1);
            MiniIsland(new Point(x + Main.rand.Next(135, 146), y + Main.rand.Next(66, 99)), 1);
            MiniIsland(new Point(x + Main.rand.Next(180, 196), y + Main.rand.Next(88, 102)), 2);
            MiniIsland(new Point(x + Main.rand.Next(180, 196), y + Main.rand.Next(44, 66)), 2);
            MiniIsland(new Point(x + Main.rand.Next(255, 266), y + Main.rand.Next(88, 102)), 1);
            MiniIsland(new Point(x + Main.rand.Next(255, 266), y + Main.rand.Next(44, 66)), 1);
        }
        ...
        public void MiniIsland(Point position, int isType)
        {
            ...
            for (int i = 0; i < 27; i++)
            {
                ...
                {
                    BlockLining(x, y - 3, 4, mod.TileType("CrystallizedMemories"), true, 6);
                }
                else if (i == 15 && Main.rand.Next(1, 3) == 1)
                {
                    BlockLining(x + 4, y - 1, 4, mod.TileType("CrystallizedMemories"), true, 6);
                }
                else if (i == 16 && Main.rand.Next(1, 3) == 1)
                {
                    BlockLining(x + 8, y, 4, mod.TileType("CrystallizedMemories"), true, 6);
                }
                else if (i == 17 && Main.rand.Next(1, 3) == 1)
                {
                    BlockLining(x + 12, y + 1, 5, mod.TileType("CrystallizedMemories"), true, 6);
                }
                else if (i == 18 && Main.rand.Next(1, 3) == 1)
                {
                    BlockLining(x + 17, y + 2, 5, mod.TileType("CrystallizedMemories"), true, 6);
                }
                else if (i == 19 && Main.rand.Next(1, 3) == 1)
                {
                    BlockLining(x + 21, y + 3, 6, mod.TileType("CrystallizedMemories"), true, 6);
                }
                else if (i == 20 && Main.rand.Next(1, 3) == 1)
                {
                    BlockLining(x + 27, y + 4, 6, mod.TileType("CrystallizedMemories"), true, 6);
                }
                else if (i == 21 && Main.rand.Next(1, 3) == 1)
                {
                    BlockLining(x + 33, y + 3, 7, mod.TileType("CrystallizedMemories"), true, 6);
                }
                else if (i == 22 && Main.rand.Next(1, 3) == 1)
                {
                    BlockLining(x + 40, y + 2, 5, mod.TileType("CrystallizedMemories"), true, 6);
                }
                else if (i == 23 && Main.rand.Next(1, 3) == 1)
                {
                    BlockLining(x + 45, y + 1, 5, mod.TileType("CrystallizedMemories"), true, 6);
                }
                else if (i == 24 && Main.rand.Next(1, 3) == 1)
                {
                    BlockLining(x + 49, y, 4, mod.TileType("CrystallizedMemories"), true, 6);
                }
                else if (i == 25 && Main.rand.Next(1, 3) == 1)
                {
                    BlockLining(x + 53, y - 1, 4, mod.TileType("CrystallizedMemories"), true, 6);
                }
                else if (i == 26 && Main.rand.Next(1, 3) == 1)
                {
                    BlockLining(x + 57, y - 2, 4, mod.TileType("CrystallizedMemories"), true, 6);
                }
                else if (i == 27 && Main.rand.Next(1, 3) == 1)
                {
                    BlockLining(x + 61, y - 3, 4, mod.TileType("CrystallizedMemories"), true, 6);
                }
            }
            ...
            switch(isType)
            {
                case 1:
                {
                        ...
                        {
                            BlockLining(x + 13, y - 12, 3, mod.TileType("CrystallizedMemories"), true, 6);
                            BlockLining(x + 15, y - 10, 2, mod.TileType("CrystallizedMemories"), true, 4);
                        }
                        else
                        {
                            BlockLining(x + 48, y - 12, 3, mod.TileType("CrystallizedMemories"), true, 6);
                            BlockLining(x + 46, y - 10, 2, mod.TileType("CrystallizedMemories"), true, 4);
                        }
