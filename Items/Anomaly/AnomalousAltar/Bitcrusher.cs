...
{
    public class Bitcrusher : ModItem
    {
        ...
        {
            DisplayName.SetDefault("Bit Crusher");
            Tooltip.SetDefault("Upon getting hit, you may release a wave of noise that stuns enemies \nThis effect does not work on bosses \n10% extra damage to start off \nAs you use the accessory the value gets higher, resetting at 1% after 25% \nDedicated to Turquoise");
        }
        ...
        public override void UpdateAccessory(Player player, bool hideVisual)
        {
            ...
            Main.LocalPlayer.GetModPlayer<VariaPlayer>().bitcrusher = true;
        }

        public override void AddRecipes()
        {
            ModRecipe recipe = new ModRecipe(mod);
            recipe.AddIngredient(mod.ItemType("Soulbinder"), 1);
            recipe.AddIngredient(mod.ItemType("AnomalousChunk"), 25);
